...
export class InputManager {
  ...
  attachTouch(dpadEl: HTMLElement, fireEl: HTMLElement, missileEl: HTMLElement, chargeEl?: HTMLElement): void {
    this.touch = new TouchSource(dpadEl, fireEl, missileEl, chargeEl);
  }
